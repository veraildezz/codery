...
public class ProjelerActivity extends AppCompatActivity {
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			final TextView baslik = _view.findViewById(R.id.baslik);
			final TextView like = _view.findViewById(R.id.like);
			
			baslik.setText(lm.get((int)_position).get("baslik").toString());
			like.setText(lm.get((int)_position).get("dil").toString());
			_RoundAndBorder(linear1, "#263238", 0, "#FFFFFF", 45);
